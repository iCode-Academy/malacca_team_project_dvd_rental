...
public class PgEnumType implements UserType<String> {
    ...
    @Override public boolean equals(String x, String y) { return x == null ? y == null : x.equals(y); }
    @Override public int hashCode(String x) { return x == null ? 0 : x.hashCode(); }
